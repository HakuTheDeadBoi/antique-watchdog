...
class ScraperManager:
    """
    Manager for loading, managing, and executing web scrapers.
    """

    @classmethod
    def _load_scrapers_dir_from_config(cls) -> str:
        """
        Load the directory path for scrapers from the configuration file.
    ...
    def collect_results(cls, queries: list[Query]) -> list[Record]:
        ...
        """
        scrapers_dir = cls._load_scrapers_dir_from_config()
